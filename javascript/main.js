...
function showResults() {
    ...
    if (userScore === 0) {
        ...
        if (window.location.hash === "#ptBr") {
            ...
            finalScoreText = "et désolé, vous n'avez pas marqué de points...";
        }
        ...
        if (window.location.hash === "#ptBr") {
            ...
            finalScoreText = `et désolé 😐, vous n'avez obtenu que <span>${userScore}</span> hors de <span>${questions.length}</span>...`
        }
        ...
        if (window.location.hash === "#ptBr") {
            ...
            finalScoreText = `et très bien ! Vous avez presque toutes les bonnes réponses ! <span>${userScore}</span> hors de <span>${questions.length}</span>`;
        }
        ...
        if (window.location.hash === "#ptBr") {
            ...
            finalScoreText = `Félicitations, tu as trouvé toutes les bonnes réponses ! Konoha est fier de toi ;) <span>${userScore}</span> hors de <span>${questions.length}</span>`;
        }
